...
{
    return [self keuYellowColor];
}

- (UIColor *)customerPrimaryColor
{
    return [self keuGreenColor];
}
...
- (UIColor *)keuGreenColor {
    return [UIColor colorWithRed:(0.0) green:(0.4078431373) blue:(0.2784313725) alpha:1.0];
}
